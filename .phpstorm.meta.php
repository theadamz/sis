...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            'access.userIdExceptions' => 'array',
            'access.groups.0.code' => 'string',
            'access.groups.0.name' => 'string',
            'access.groups.0.visible' => 'boolean',
            'access.groups.1.code' => 'string',
            'access.groups.1.name' => 'string',
            'access.groups.1.visible' => 'boolean',
            'access.groups.2.code' => 'string',
            'access.groups.2.name' => 'string',
            'access.groups.2.visible' => 'boolean',
            'access.groups.3.code' => 'string',
            'access.groups.3.name' => 'string',
            'access.groups.3.visible' => 'boolean',
            'access.groups.4.code' => 'string',
            'access.groups.4.name' => 'string',
            'access.groups.4.visible' => 'boolean',
            'access.menus.0.group_code' => 'string',
            'access.menus.0.parent_menu_code' => 'string',
            'access.menus.0.code' => 'string',
            'access.menus.0.name' => 'string',
            'access.menus.0.description' => 'string',
            'access.menus.0.path' => 'NULL',
            'access.menus.0.icon' => 'string',
            'access.menus.0.visible' => 'boolean',
            'access.menus.0.children.0.group_code' => 'string',
            'access.menus.0.children.0.parent_menu_code' => 'string',
            'access.menus.0.children.0.code' => 'string',
            'access.menus.0.children.0.name' => 'string',
            'access.menus.0.children.0.description' => 'string',
            'access.menus.0.children.0.path' => 'string',
            'access.menus.0.children.0.icon' => 'string',
            'access.menus.0.children.0.visible' => 'boolean',
            'access.menus.0.children.0.children' => 'NULL',
            'access.menus.0.children.1.group_code' => 'string',
            'access.menus.0.children.1.parent_menu_code' => 'string',
            'access.menus.0.children.1.code' => 'string',
            'access.menus.0.children.1.name' => 'string',
            'access.menus.0.children.1.description' => 'string',
            'access.menus.0.children.1.path' => 'string',
            'access.menus.0.children.1.icon' => 'string',
            'access.menus.0.children.1.visible' => 'boolean',
            'access.menus.0.children.1.children' => 'NULL',
            'access.menus.0.children.2.group_code' => 'string',
            'access.menus.0.children.2.parent_menu_code' => 'string',
            'access.menus.0.children.2.code' => 'string',
            'access.menus.0.children.2.name' => 'string',
            'access.menus.0.children.2.description' => 'string',
            'access.menus.0.children.2.path' => 'string',
            'access.menus.0.children.2.icon' => 'string',
            'access.menus.0.children.2.visible' => 'boolean',
            'access.menus.0.children.2.children' => 'NULL',
            'access.menus.1.group_code' => 'string',
            'access.menus.1.parent_menu_code' => 'string',
            'access.menus.1.code' => 'string',
            'access.menus.1.name' => 'string',
            'access.menus.1.description' => 'string',
            'access.menus.1.path' => 'NULL',
            'access.menus.1.icon' => 'string',
            'access.menus.1.visible' => 'boolean',
            'access.menus.1.children.0.group_code' => 'string',
            'access.menus.1.children.0.parent_menu_code' => 'string',
            'access.menus.1.children.0.code' => 'string',
            'access.menus.1.children.0.name' => 'string',
            'access.menus.1.children.0.description' => 'string',
            'access.menus.1.children.0.path' => 'string',
            'access.menus.1.children.0.icon' => 'string',
            'access.menus.1.children.0.visible' => 'boolean',
            'access.menus.1.children.0.children' => 'NULL',
            'access.menus.1.children.1.group_code' => 'string',
            'access.menus.1.children.1.parent_menu_code' => 'string',
            'access.menus.1.children.1.code' => 'string',
            'access.menus.1.children.1.name' => 'string',
            'access.menus.1.children.1.description' => 'string',
            'access.menus.1.children.1.path' => 'string',
            'access.menus.1.children.1.icon' => 'string',
            'access.menus.1.children.1.visible' => 'boolean',
            'access.menus.1.children.1.children' => 'NULL',
            'access.menus.2.group_code' => 'string',
            'access.menus.2.parent_menu_code' => 'string',
            'access.menus.2.code' => 'string',
            'access.menus.2.name' => 'string',
            'access.menus.2.description' => 'string',
            'access.menus.2.path' => 'string',
            'access.menus.2.icon' => 'string',
            'access.menus.2.visible' => 'boolean',
            'access.menus.2.children' => 'NULL',
            'access.menus.3.group_code' => 'string',
            'access.menus.3.parent_menu_code' => 'string',
            'access.menus.3.code' => 'string',
            'access.menus.3.name' => 'string',
            'access.menus.3.description' => 'string',
            'access.menus.3.path' => 'string',
            'access.menus.3.icon' => 'string',
            'access.menus.3.visible' => 'boolean',
            'access.menus.3.children' => 'NULL',
            'access.menus.4.group_code' => 'string',
            'access.menus.4.parent_menu_code' => 'string',
            'access.menus.4.code' => 'string',
            'access.menus.4.name' => 'string',
            'access.menus.4.description' => 'string',
            'access.menus.4.path' => 'string',
            'access.menus.4.icon' => 'string',
            'access.menus.4.visible' => 'boolean',
            'access.menus.4.children' => 'NULL',
            'access.menus.5.group_code' => 'string',
            'access.menus.5.parent_menu_code' => 'string',
            'access.menus.5.code' => 'string',
            'access.menus.5.name' => 'string',
            'access.menus.5.description' => 'string',
            'access.menus.5.path' => 'string',
            'access.menus.5.icon' => 'string',
            'access.menus.5.visible' => 'boolean',
            'access.menus.5.children' => 'NULL',
            'access.menus.6.group_code' => 'string',
            'access.menus.6.parent_menu_code' => 'string',
            'access.menus.6.code' => 'string',
            'access.menus.6.name' => 'string',
            'access.menus.6.description' => 'string',
            'access.menus.6.path' => 'string',
            'access.menus.6.icon' => 'string',
            'access.menus.6.visible' => 'boolean',
            'access.menus.6.children' => 'NULL',
            'access.menus.7.group_code' => 'string',
            'access.menus.7.parent_menu_code' => 'string',
            'access.menus.7.code' => 'string',
            'access.menus.7.name' => 'string',
            'access.menus.7.description' => 'string',
            'access.menus.7.path' => 'string',
            'access.menus.7.icon' => 'string',
            'access.menus.7.visible' => 'boolean',
            'access.menus.7.children' => 'NULL',
            'access.lists.0.code' => 'string',
            'access.lists.0.name' => 'string',
            'access.lists.0.permissions' => 'array',
            'access.lists.1.code' => 'string',
            'access.lists.1.name' => 'string',
            'access.lists.1.permissions' => 'array',
            'access.lists.2.code' => 'string',
            'access.lists.2.name' => 'string',
            'access.lists.2.permissions' => 'array',
            'access.lists.3.code' => 'string',
            'access.lists.3.name' => 'string',
            'access.lists.3.permissions' => 'array',
            'access.lists.4.code' => 'string',
            'access.lists.4.name' => 'string',
            'access.lists.4.permissions' => 'array',
            'access.lists.5.code' => 'string',
            'access.lists.5.name' => 'string',
            'access.lists.5.permissions' => 'array',
            'access.lists.6.code' => 'string',
            'access.lists.6.name' => 'string',
            'access.lists.6.permissions' => 'array',
            'access.lists.7.code' => 'string',
            'access.lists.7.name' => 'string',
            'access.lists.7.permissions' => 'array',
            'access.lists.8.code' => 'string',
            'access.lists.8.name' => 'string',
            'access.lists.8.permissions' => 'array',
            'access.lists.9.code' => 'string',
            'access.lists.9.name' => 'string',
            'access.lists.9.permissions' => 'array',
            'access.lists.10.code' => 'string',
            'access.lists.10.name' => 'string',
            'access.lists.10.permissions' => 'array',
            'access.lists.11.code' => 'string',
            'access.lists.11.name' => 'string',
            'access.lists.11.permissions' => 'array',
            'access.lists.12.code' => 'string',
            'access.lists.12.name' => 'string',
            'access.lists.12.permissions' => 'array',
            'access.lists.13.code' => 'string',
            'access.lists.13.name' => 'string',
            'access.lists.13.permissions' => 'array',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links.D:\laragon\www\sis\public\storage' => 'string',
            ...
            'setting.general.web_name' => 'string',
            'setting.general.web_name_short' => 'string',
            'setting.general.web_description' => 'string',
            'setting.general.web_keywords' => 'string',
            'setting.general.web_author' => 'string',
            'setting.general.web_email' => 'string',
            'setting.general.company_name' => 'string',
            'setting.general.company_name_short' => 'string',
            'setting.general.version' => 'string',
            'setting.general.copyright' => 'string',
            'setting.local.charset' => 'string',
            'setting.local.locale' => 'string',
            'setting.local.locale_short' => 'string',
            'setting.local.locale_long' => 'string',
            'setting.local.timezone' => 'string',
            'setting.local.country' => 'string',
            'setting.local.numeric_thousand_separator' => 'string',
            'setting.local.numeric_decimal_separator' => 'string',
            'setting.local.numeric_precision_length' => 'integer',
            'setting.local.js_date_format' => 'string',
            'setting.local.js_time_format' => 'string',
            'setting.local.js_datetime_format' => 'string',
            'setting.local.jasper_format_date' => 'string',
            'setting.local.jasper_format_time' => 'string',
            'setting.local.jasper_format_datetime' => 'string',
            'setting.local.jasper_format_integer' => 'string',
            'setting.local.jasper_format_float' => 'string',
            'setting.local.jasper_format_number' => 'string',
            'setting.local.backend_datetime_format' => 'string',
            'setting.local.backend_date_format' => 'string',
            'setting.local.backend_time_format' => 'string',
            'setting.other.max_file_attachment' => 'integer',
            'setting.other.max_file_size' => 'integer',
            'setting.other.file_doc_attachment_allowed' => 'array',
            'setting.other.file_img_allowed' => 'array',
            'setting.other.path_to_upload' => 'string',
            'setting.other.path_to_temp' => 'string',
            'setting.page.limits' => 'array',
            'setting.page.default_limit' => 'integer',
            'setting.sequence.year_format' => 'string',
            'setting.sequence.month_format' => 'string',
            'setting.sequence.array_format.site_code' => 'string',
            'setting.sequence.array_format.prefix' => 'string',
            'setting.sequence.array_format.suffix' => 'string',
            'setting.sequence.array_format.year' => 'string',
            'setting.sequence.array_format.month' => 'string',
            'setting.sequence.array_format.seq' => 'string',
            'setting.sequence.format_seq_default' => 'string',
            'setting.method.allowed' => 'array',
            'setting.cache_time' => 'integer',
            'setting.regxp.forCode' => 'string',
            'setting.regxp.forUsername' => 'string',
            'setting.regxp.forTransType' => 'string',
            'setting.data.test' => 'array',
...
'access.userIdExceptions','access.groups.0.code','access.groups.0.name','access.groups.0.visible','access.groups.1.code',
'access.groups.1.name','access.groups.1.visible','access.groups.2.code','access.groups.2.name','access.groups.2.visible',
'access.groups.3.code','access.groups.3.name','access.groups.3.visible','access.groups.4.code','access.groups.4.name',
'access.groups.4.visible','access.menus.0.group_code','access.menus.0.parent_menu_code','access.menus.0.code','access.menus.0.name',
'access.menus.0.description','access.menus.0.path','access.menus.0.icon','access.menus.0.visible','access.menus.0.children.0.group_code',
'access.menus.0.children.0.parent_menu_code','access.menus.0.children.0.code','access.menus.0.children.0.name','access.menus.0.children.0.description','access.menus.0.children.0.path',
'access.menus.0.children.0.icon','access.menus.0.children.0.visible','access.menus.0.children.0.children','access.menus.0.children.1.group_code','access.menus.0.children.1.parent_menu_code',
'access.menus.0.children.1.code','access.menus.0.children.1.name','access.menus.0.children.1.description','access.menus.0.children.1.path','access.menus.0.children.1.icon',
'access.menus.0.children.1.visible','access.menus.0.children.1.children','access.menus.0.children.2.group_code','access.menus.0.children.2.parent_menu_code','access.menus.0.children.2.code',
'access.menus.0.children.2.name','access.menus.0.children.2.description','access.menus.0.children.2.path','access.menus.0.children.2.icon','access.menus.0.children.2.visible',
'access.menus.0.children.2.children','access.menus.1.group_code','access.menus.1.parent_menu_code','access.menus.1.code','access.menus.1.name',
'access.menus.1.description','access.menus.1.path','access.menus.1.icon','access.menus.1.visible','access.menus.1.children.0.group_code',
'access.menus.1.children.0.parent_menu_code','access.menus.1.children.0.code','access.menus.1.children.0.name','access.menus.1.children.0.description','access.menus.1.children.0.path',
'access.menus.1.children.0.icon','access.menus.1.children.0.visible','access.menus.1.children.0.children','access.menus.1.children.1.group_code','access.menus.1.children.1.parent_menu_code',
'access.menus.1.children.1.code','access.menus.1.children.1.name','access.menus.1.children.1.description','access.menus.1.children.1.path','access.menus.1.children.1.icon',
'access.menus.1.children.1.visible','access.menus.1.children.1.children','access.menus.2.group_code','access.menus.2.parent_menu_code','access.menus.2.code',
'access.menus.2.name','access.menus.2.description','access.menus.2.path','access.menus.2.icon','access.menus.2.visible',
'access.menus.2.children','access.menus.3.group_code','access.menus.3.parent_menu_code','access.menus.3.code','access.menus.3.name',
'access.menus.3.description','access.menus.3.path','access.menus.3.icon','access.menus.3.visible','access.menus.3.children',
'access.menus.4.group_code','access.menus.4.parent_menu_code','access.menus.4.code','access.menus.4.name','access.menus.4.description',
'access.menus.4.path','access.menus.4.icon','access.menus.4.visible','access.menus.4.children','access.menus.5.group_code',
'access.menus.5.parent_menu_code','access.menus.5.code','access.menus.5.name','access.menus.5.description','access.menus.5.path',
'access.menus.5.icon','access.menus.5.visible','access.menus.5.children','access.menus.6.group_code','access.menus.6.parent_menu_code',
'access.menus.6.code','access.menus.6.name','access.menus.6.description','access.menus.6.path','access.menus.6.icon',
'access.menus.6.visible','access.menus.6.children','access.menus.7.group_code','access.menus.7.parent_menu_code','access.menus.7.code',
'access.menus.7.name','access.menus.7.description','access.menus.7.path','access.menus.7.icon','access.menus.7.visible',
'access.menus.7.children','access.lists.0.code','access.lists.0.name','access.lists.0.permissions','access.lists.1.code',
'access.lists.1.name','access.lists.1.permissions','access.lists.2.code','access.lists.2.name','access.lists.2.permissions',
'access.lists.3.code','access.lists.3.name','access.lists.3.permissions','access.lists.4.code','access.lists.4.name',
'access.lists.4.permissions','access.lists.5.code','access.lists.5.name','access.lists.5.permissions','access.lists.6.code',
'access.lists.6.name','access.lists.6.permissions','access.lists.7.code','access.lists.7.name','access.lists.7.permissions',
'access.lists.8.code','access.lists.8.name','access.lists.8.permissions','access.lists.9.code','access.lists.9.name',
'access.lists.9.permissions','access.lists.10.code','access.lists.10.name','access.lists.10.permissions','access.lists.11.code',
'access.lists.11.name','access.lists.11.permissions','access.lists.12.code','access.lists.12.name','access.lists.12.permissions',
'access.lists.13.code','access.lists.13.name','access.lists.13.permissions','app.name','app.env',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\laragon\\www\\sis\\public\\storage','inertia.ssr.enabled','inertia.ssr.url',
...
'setting.general.web_name','setting.general.web_name_short','setting.general.web_description','setting.general.web_keywords','setting.general.web_author',
'setting.general.web_email','setting.general.company_name','setting.general.company_name_short','setting.general.version','setting.general.copyright',
'setting.local.charset','setting.local.locale','setting.local.locale_short','setting.local.locale_long','setting.local.timezone',
'setting.local.country','setting.local.numeric_thousand_separator','setting.local.numeric_decimal_separator','setting.local.numeric_precision_length','setting.local.js_date_format',
'setting.local.js_time_format','setting.local.js_datetime_format','setting.local.jasper_format_date','setting.local.jasper_format_time','setting.local.jasper_format_datetime',
'setting.local.jasper_format_integer','setting.local.jasper_format_float','setting.local.jasper_format_number','setting.local.backend_datetime_format','setting.local.backend_date_format',
'setting.local.backend_time_format','setting.other.max_file_attachment','setting.other.max_file_size','setting.other.file_doc_attachment_allowed','setting.other.file_img_allowed',
'setting.other.path_to_upload','setting.other.path_to_temp','setting.page.limits','setting.page.default_limit','setting.sequence.year_format',
'setting.sequence.month_format','setting.sequence.array_format.site_code','setting.sequence.array_format.prefix','setting.sequence.array_format.suffix','setting.sequence.array_format.year',
'setting.sequence.array_format.month','setting.sequence.array_format.seq','setting.sequence.format_seq_default','setting.method.allowed','setting.cache_time',
'setting.regxp.forCode','setting.regxp.forUsername','setting.regxp.forTransType','setting.data.test','broadcasting.default',
...
'debugbar.queries.explain','sanctum.csrf-cookie','home',
'dashboard','profile.edit','profile.update','profile.destroy',
'password.edit','password.update','appearance','register',
