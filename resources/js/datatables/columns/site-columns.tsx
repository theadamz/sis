...
export const SiteColumns: ColumnDef<SiteDT, unknown>[] = [
    ...
    },
    {
        ...
        meta: {
            columnDisplayName: 'Entity',
        },
        header: () => <Label>Entity</Label>,
    },
    {
        accessorKey: 'code',
        meta: {
    ...
    },
    {
        ...
        meta: {
            columnDisplayName: 'Timezone',
        },
        header: () => {
            return <Label>Timezone</Label>;
        },
    },
    {
        ...
        cell: ({ row }) => <Badge variant={row.getValue('is_active') ? 'outline' : 'destructive'}>{row.getValue('is_active') ? 'Yes' : 'No'}</Badge>,
    },
    {
        id: 'actions',
        enableHiding: false,
